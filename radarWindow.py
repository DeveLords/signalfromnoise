...
class RadarWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # self.breathWaveForm = widgetFreq('Breating')
        # self.HeartWaveForm = widgetFreq('Heart')
        ...
        layout.addWidget(grp, 0, 0, -1, 1)
        layout.addWidget(self.plotRadar, 0, 1, 1, -1, QtCore.Qt.AlignCenter)
        # layout.addWidget(self.breathWaveForm, 2, 1)
        # layout.addWidget(self.HeartWaveForm, 2, 2)
    ...
    def updatePlot(self):
        ...
        # self.breathWaveForm.updateWaveform2()
        # self.HeartWaveForm.updateWaveform2()
